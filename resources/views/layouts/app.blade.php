    ...
    <div id="app">
        <nav class="navbar">
            <div class="flex items-center">
                <svg class="text-white fill-current mr-2 mb-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24">
                    <path
            ...
            <ul class="navbar-right">
                ...
                @else
                <li class="nav-item">
                    <a class="nav-link flex items-center" href="{{ route('logout') }}" onclick="event.preventDefault();
